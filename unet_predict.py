...
model.load_state_dict(torch.load(r"C:\Users\dingyi.zhang\Documents\CV-Calcium-DY\checkpoints\3DUNet_50.h5"))
model.cuda()

test_dataset = CVC(start=0.0, end=1.0)
test_loader = torch.utils.data.DataLoader(test_dataset, batch_size=1)
weight = torch.Tensor([0.01, 1.0, 1.0, 1.0, 1.0])
...
save_dir = r'C:\Users\dingyi.zhang\Documents\CV-Calcium-DY\inference'
